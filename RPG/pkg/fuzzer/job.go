...
func (job *triageJob) run(fuzzer *Fuzzer) {
	// df: lower the priority of fuzzer.ct.df_configPrio
	fuzzer.ct.DF_LowerChoiceTable()
	...
	// df: update choice table with new input
	fuzzer.ct.DF_UpdateChoiceTable(job.p)
