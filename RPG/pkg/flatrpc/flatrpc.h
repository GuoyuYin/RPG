...
static_assert((FLATBUFFERS_VERSION_MAJOR == 24 && FLATBUFFERS_VERSION_MINOR >= 0) ||
...
inline void ConnectReplyRaw::UnPackTo(ConnectReplyRawT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = globs(); if (_e) { _o->globs.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->globs[_i] = _e->Get(_i)->str(); } } else { _o->globs.resize(0); } }
}
...
inline void InfoRequestRaw::UnPackTo(InfoRequestRawT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = globs(); if (_e) { _o->globs.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->globs[_i]) { _e->Get(_i)->UnPackTo(_o->globs[_i].get(), _resolver); } else { _o->globs[_i] = std::unique_ptr<rpc::GlobInfoRawT>(_e->Get(_i)->UnPack(_resolver)); }; } } else { _o->globs.resize(0); } }
}
...
inline void ExecRequestRaw::UnPackTo(ExecRequestRawT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = signal_filter(); if (_e) { _o->signal_filter.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->signal_filter[_i] = _e->Get(_i); } } else { _o->signal_filter.resize(0); } }
...
inline void SignalUpdateRaw::UnPackTo(SignalUpdateRawT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = drop_max(); if (_e) { _o->drop_max.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->drop_max[_i] = _e->Get(_i); } } else { _o->drop_max.resize(0); } }
}
